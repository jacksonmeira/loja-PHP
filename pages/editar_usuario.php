...
if (isset($_POST['enviar'])) {
    ...
    if (count($erro) == 0) {
        ...
        die("<script>location.href=\"index.php?p=gerenciar_usuarios&msg=editado\";</script>");
    }
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="creditos" class="form-control" value="<?php echo $usuario['creditos']; ?>">
                                </div>
                            </div>
