...
if(isset($_POST['enviar'])){
        ...
        if(!isset($_FILES) || !isset($_FILES['imagem']) || $_FILES['imagem']['size'] == 0){
            $erro[] = "Anexe uma imagem no formato .jpg ou .png";
        }
                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-8">
                             <div class="form-group">
                                 ...
                                 <input type="text" name="descricao_curta" class="form-control" value="<?php if(isset($_POST['descricao_curta'])) echo $_POST['descricao_curta'];?>">
                             </div>
                         </div>
                         ...
                         <div class="col-lg-8">
                             <div class="form-group">
                                 ...
                                 <input type="text" name="preco" class="form-control" value="<?php if(isset($_POST['preco'])) echo $_POST['preco'];?>">
                             </div>
                         </div>
                         ...
                         <div class="col-lg-12">
                             <div class="form-group">
                                 ...
                                 <textarea name="conteudo" rows="10" class="form-control"><?php if(isset($_POST['conteudo'])) echo $_POST['conteudo'];?></textarea>
                             </div>
                         </div>
