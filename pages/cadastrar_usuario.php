                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome" class="form-control" value="<?php if (isset($_POST['nome'])) echo $_POST['nome']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="creditos" class="form-control" value="<?php if (isset($_POST['credito'])) echo $_POST['credito']; ?>">
                                </div>
                            </div>
